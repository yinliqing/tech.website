...
org.webjars:bootstrap jquery-ui jquery
...
pom.xml
           <plugin>
                ...
                <version>2.3</version>
                <configuration>
                	<webappDirectory>D:/apache-tomcat-9.0.0.M1/webapps/introduction</webappDirectory>
                	<warName>introduction</warName>
                </configuration>
            </plugin>
...
/introduction/src/main/resources/introduction/mvc-core-config.xml
/introduction/src/main/resources/introduction/mvc-view-config.xml
...
```
docker run -e MYSQL_ROOT_PASSWORD=introduction -e MYSQL_DATABASE=introduction -p 3306:3306 mysql:5.7.8
```

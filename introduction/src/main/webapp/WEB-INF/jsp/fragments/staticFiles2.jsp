...
<head>
    ...
    <spring:url value="/resources/css/docs.min.css" var="docsCss"/>
    <link href="${docsCss}" rel="stylesheet"/>
    ...
    <spring:url value="/resources/js/ie-emulation-modes-warning.js" var="ieEmulationModesWarning"/>
    <script src="${ieEmulationModesWarning}"></script>
</head>
